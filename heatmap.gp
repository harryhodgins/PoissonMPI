...
set output 'heatmap_2d_31.png'

# Set the title of the plot
set title 'Solution Heatmap of Discretized Poisson Equation (2D Domain Decomposition)'
...
set xrange[0:31]
# Plot the data
splot 'global_2d_31_0.txt' matrix with image